const keys = {
  ...
  ruLowerCase: ['ё', '1', '2', '3', '4', '5', '6', '7', '8', '9', '0', '-', '=',
    'Backspace', 'Tab', 'й', 'ц', 'у', 'к', 'е', 'н', 'г', 'ш', 'щ', 'з', 'х', 'ъ', '\\', 'Del',
    'CapsLock', 'ф', 'ы', 'в', 'а', 'п', 'р', 'о', 'л', 'д', 'ж', 'э', 'Enter', 'Shift',
    'я', 'ч', 'с', 'м', 'и', 'т', 'ь', 'б', 'ю', '.', '&#x25b2; ', 'Shift', 'Ctrl', 'Win',
    'Alt', ' ', 'Alt', '&#x25c0; ', '&#x25bc; ', '&#x25b6; ', 'Ctrl'],

  engUpperCase: ['~', '!', '@', '#', '$', '%', '^', '&', '*', '(', ')', '_', '+',
    'Backspace', 'Tab', 'Q', 'W', 'E', 'R', 'T', 'Y', 'U', 'I', 'O', 'P', '{', '}', '|', 'Del',
    'CapsLock', 'A', 'S', 'D', 'F', 'G', 'H', 'J', 'K', 'I', ':', '"', 'Enter', 'Shift',
    'Z', 'X', 'C', 'V', 'B', 'N', 'M', '<', '>', '?', '&#x25b2; ', 'Shift', 'Ctrl', 'Win',
    'Alt', ' ', 'Alt', '&#x25c0; ', '&#x25bc; ', '&#x25b6; ', 'Ctrl'],

  engLowerCase: ['`', '1', '2', '3', '4', '5', '6', '7', '8', '9', '0', '-', '=',
    'Backspace', 'Tab', 'q', 'w', 'e', 'r', 't', 'y', 'u', 'i', 'o', 'p', '[', ']', '\\', 'Del',
    'CapsLock', 'a', 's', 'd', 'f', 'g', 'h', 'j', 'k', 'l', ';', `'`, 'Enter', 'Shift', 'z',
    'x', 'c', 'v', 'b', 'n', 'm', ',', '.', '/', '&#x25b2; ', 'Shift', 'Ctrl', 'Win', 'Alt',
    ' ', 'Alt', '&#x25c0; ', '&#x25bc; ', '&#x25b6; ', 'Ctrl'],
  ...
  keyCode: ['Backquote', 'Digit1', 'Digit2', 'Digit3', 'Digit4', 'Digit5', 'Digit6',
    ...
    'BracketLeft', 'BracketRight', 'Backslash', 'Delete', 'CapsLock', 'KeyA', 'KeyS', 'KeyD', 'KeyF',
